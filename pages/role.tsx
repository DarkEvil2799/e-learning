        ...
        <div className="relative pt-8 pb-10 lg:py-16">
          <div className="relative mx-auto">      
            <div className="text-center">
              ...
              <p className="mt-3 mx-auto text-lg font-medium sm:text-xl text-gray-400 sm:mt-4">
            ...
            <div className="flex flex-row mt-8 sm:gap-8">
              ...
              onClick={() => selectRole("lecturer")}
                className="flex-1 transition-colors h-auto hover:bg-gray-100 rounded-xl cursor-pointer p-8 active:ring-4">
                <img
