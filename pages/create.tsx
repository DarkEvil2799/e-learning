        ...
        <div className="relative pt-8 pb-10 lg:py-16">
          ...
          <form ref={form} onSubmit={handleFormSubmit}>
            <div className="space-y-6">
              <div>
                <h1 className="text-4xl leading-6 font-bold text-gray-900">New Class</h1>
              ...
              <div>
                <label htmlFor="class-name" className="block text-lg font-bold text-gray-900">
                  Class Name
                </label>
                <div className="mt-1">
                  <input
                    ...
                    name="class-name"
                    required={true}
                    className="block w-full bg-gray-100 shadow-sm focus:ring-blue-400 border-gray-300 rounded-md"
              ...
              <div className="space-y-2">
                <div className="space-y-1">
                  <label htmlFor="students" className="block text-lg font-bold text-gray-900">
                    Students
                  </label>
                  <p id="students-helper" className="sr-only">
                  ...
                  <div className="flex">
                    ...
                    <span className="ml-3">
                      <button
                        ...
                        disabled={(student === "")}
                        type="button"
                        className="bg-green-500 transition-colors inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm font-medium rounded-md text-white hover:bg-green-600 active:outline-none active:ring-2 active:ring-offset-2 active:ring-green-400 disabled:bg-green-300"
                      >
                ...
                <div className="border-b border-gray-200">
                  { students.length > 0 ? (
                      ...
                      {students.map((student:any) => (
                        <li key={student.email} className="py-4 flex">
                          ...
                          <button 
                            ...
                            className="px-3 my-1 text-white text-sm bg-red-500 rounded-full hover:bg-red-600">
                            remove
                          </button>
                        </li>
                      ))}
                    ...
                    <p className="text-center text-gray-500 my-4">The class is currently empty. Try adding some students!</p>
                  ) }
                </div>
              </div>
              ...
              <div className="flex">
                ...
                <button
                  ...
                  type="button"
                  className="ml-3 inline-flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm font-medium text-white bg-blue-500 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:bg-blue-300"
                >
                  Create class
                </button>
              </div>
