...
export default function AnnouncementList({
  ...
  return (
    ...
    <div className="flex bg-white mt-4 py-4 border-b border-gray-200">
      <h3 className="text-xl leading-6 font-medium text-gray-900">Annoucements</h3>
      {announcements && announcements.length > 0 && (
        ...
        <div className="flex-1 flex justify-between sm:justify-end">
          <button
            ...
            className="relative inline-flex items-center text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-200 hover:text-blue-500 disabled:text-gray-500"
          >
            <ChevronLeftIcon className="h-5 w-5" />
          </button>
          <span className="mx-2">{currentIndex+1}/{announcements.length}</span>
          <button
      ...
      <div className="flow-root">
        {announcement && announcements && announcements.length > 0 ? (
          <div className="divide-y divide-gray-200">
            <div
              className="relative bg-red-100 py-5 px-4"
            >
