...
import { API_BASE_URL, API_FILE_URL, API_UPLOAD_URL } from "../../lib/constants"
  ...
  const sendMessage = (e:any) => {
    ...
    if (e.key === "Enter") {
      fetch(`${API_BASE_URL}/classes/${classId}/messages`, {
        ...
        body: JSON.stringify(        {
          "author": session?.user?.name ?? "johndoe",
      ...
      <div className="p-4">
          ...
          <div className="relative flex">
            <input 
              ...
              className="w-full bg-white border-gray-300 focus:outline-none focus:placeholder-gray-400 focus:ring-blue-400 text-gray-900 placeholder-gray-600 pl-4 pr-16 rounded-lg py-2" />          
