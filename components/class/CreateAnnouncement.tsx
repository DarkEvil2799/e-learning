          ...
          <div className="fixed inset-y-0 pl-16 max-w-full right-0 flex">
            ...
            >
              <div className="w-screen max-w-md">
                <form ref={form} onSubmit={handleFormSubmit} className="h-full divide-y divide-gray-200 flex flex-col bg-white shadow-xl">
                  <div className="flex-1 h-0 overflow-y-auto">
                    <div className="py-6 px-4 bg-blue-700 sm:px-6">
                      <div className="flex items-center justify-between">
                        <Dialog.Title className="text-lg font-medium text-white">New Announcement</Dialog.Title>
                    ...
                    <div className="flex-1 flex flex-col justify-between">
                      <div className="px-4 divide-y divide-gray-200 sm:px-6">
                        <div className="space-y-6 pt-6 pb-5">
                          <div>
                            <label htmlFor="announcement-name" className="block text-base font-medium text-gray-900">
                              Announcement name
                            </label>
                            <div className="mt-1">
                              <input
                                ...
                                className="block w-full shadow-sm sm:text-base focus:ring-blue-500 focus:border-blue-500 border-gray-300 rounded-md"
                              />
                            </div>
                          </div>
                          <div>
                            <label htmlFor="detail" className="block text-base font-medium text-gray-900">
                              Detail
                            </label>
                            <div className="mt-1">
                              <textarea
                                ...
                                rows={10}
                                className="block w-full shadow-sm sm:text-base focus:ring-blue-500 focus:border-blue-500 border border-gray-300 rounded-md"
                              />
                            </div>
                          </div>
                          <div>
                  ...
                  <div className="flex-shrink-0 px-4 py-4 flex justify-end">
                    ...
                    { isPostSucceess === null && (
                      <button
                        ...
                        type="submit"
                        className="ml-4 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:bg-blue-300"
                      >
                        Create
                      </button>
                    )}
