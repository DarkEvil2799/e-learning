...
const Header = () => {
  ...
  return (
<Disclosure as="nav" className="bg-blue-500 py-6">
{({ open }) => (
  <>
        <nav className="max-w-7xl mx-auto px-8" aria-label="Global">
            ...
            { user ? (
                <div className="hidden md:ml-4 md:flex-shrink-0 md:flex md:items-center">
                  ...
                  <Menu as="div" className="ml-4 relative">
                    {({ open }) => (
                      <>
                        <div>
                          <Menu.Button className="max-w-xs transition bg-blue-500 rounded-full flex items-center text-sm active:ring-2 active:ring-blue-300 p-2 lg:rounded-full lg:hover:bg-blue-600">
                            {/* <span className="w-8 h-8 bg-white rounded-full text-center"></span> */}
                            <img src={user.image ?? ""} alt="" className="w-8 h-8 rounded-full" />
                            <span className="ml-2 text-white text-base font-medium lg:block">
                              <span className="sr-only">Open user menu for </span>{user.name}
                            </span>
                            <ChevronDownIcon
                              className="hidden flex-shrink-0 h-3 w-4 text-white lg:block"
                              aria-hidden="true"
                            />
                          </Menu.Button>
                        </div>
                ...
                <button type="submit"
                        ...
                        className="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md text-white hover:text-blue-200">
                    Sign in
                </button>
                </div>)
            }
                ...
                <div className="py-3">
                    ...
                    <div className="mt-4 space-y-2">
                      <button
                          ...
                          className="block w-full text-left px-3 py-2 rounded-md text-base font-medium text-white hover:text-white hover:bg-blue-600"
                      >  
                        Sign Out
                      </button>                    
                    </div>
