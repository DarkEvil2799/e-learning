      ...
      <div className="mx-auto lg:mx-0 w-full max-w-lg">
        <div>
          <div className="flex flex-row items-center space-x-4">
            <span className="w-14 h-14 bg-blue-500 rounded"></span>
            <span className="text-2xl font-bold">e-learning</span>
          </div>
          <h2 className="mt-12 text-6xl font-black leading-snug text-gray-900">
            Online Studying&nbsp;
            <p className="text-blue-500">Made Easy</p>
          </h2>
        </div>
